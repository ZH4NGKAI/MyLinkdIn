...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
            ...
            if(session.getAttribute("USER") == null && !url.contains("login.htm") && !url.contains("pwdhelp.htm") && !url.contains("register.htm")) {
//                RequestDispatcher requestDispatcher = request.getRequestDispatcher("login.htm");
//                requestDispatcher.forward(request, response);
                response.sendRedirect(request.getContextPath() + "/login.htm"); // here goto http://yourdoamin/login.html
